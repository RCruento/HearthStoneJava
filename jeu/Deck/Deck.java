...
public class Deck {
    ...
    public Deck(IJoueur owner)
    {
        ...
        if(owner.getHeros().getPersonage().equals("Jaina") ){
            ...
            Carte CSoJ4 = new Sort(owner,"Image mirroir", 1, new jeu.Capacites.Miroir());
        ...
        if (owner.getHeros().getPersonage().equals("Rexxar")) {
                ...
                Carte CSoR3 = new Sort(owner,"Lâchez les chiens", 3, new jeu.Capacites.Chiens());
        ...
        Carte CSe5 = new Serviteur(owner,"La missilière téméraire", 6, 5, 2, new jeu.Capacites.Charge());
        Carte CSe6 = new Serviteur(owner,"L'ogre-magi", 4, 4, 4, new jeu.Capacites.Provocation());
        Carte CSe7 = new Serviteur(owner,"Archimage", 6, 4, 7, new jeu.Capacites.Provocation());
        //Carte CSe8 = new Serviteur(owner,"Gnôme lépreux", 1, 1, 1, "Attaque du lépreux");
        Carte CSe9 = new Serviteur(owner,"L'ogre-magi", 4, 4, 4 );
        //Carte CSo2 = new Sort(owner, "Attaque mentale", 2, "Attaque mentale");
        //this.addCarte(CSe1);
        //this.addCarte(CSe2);
        //this.addCarte(CSe3);
        //this.addCarte(CSe4);
    ...
    //getters setters
    public void setProrio(IJoueur owner) {
        if (owner != null){
            this.owner = owner;
        }else{
